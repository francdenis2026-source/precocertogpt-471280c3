...
import "./reference/HomepageEditorialRedesign2026.css";
...
export default function App(){return <BrowserRouter><FavoritesProvider><a className="pc-skip-link" href="#conteudo-principal">Pular para o conteúdo</a><SeoRouteManager/><RouteFocusManager/><DorinhaCommerceEnhancer/><AdminLoginRedirect/><AdminProductEditorOverlay/><AdminMaintenanceControl/><AdminVideoQuickAccess/><ProductCardQuickActions/><UserAccountHub/><PlatformMaintenanceGate><Suspense fallback={<main className="pc-route-loading" aria-live="polite">Carregando…</main>}><Routes>
...
</Routes></Suspense></PlatformMaintenanceGate></FavoritesProvider></BrowserRouter>}
