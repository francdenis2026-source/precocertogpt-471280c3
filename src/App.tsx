...
import { AdminPanelExtensions } from "./components/AdminPanelExtensions";
...
export default function App(){return <BrowserRouter><FavoritesProvider><a className="pc-skip-link" href="#conteudo-principal">Pular para o conteúdo</a><RouteFocusManager/><AdminLoginRedirect/><AdminPanelExtensions/><ProductCardQuickActions/><FooterDeveloperInfo/><UserAccountHub/><Routes>
