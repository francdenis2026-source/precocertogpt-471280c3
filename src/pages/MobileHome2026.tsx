  ...
  <main id="conteudo-principal">
   <section className="mh26-hero">
    ...
    <div className="mh26-hero-media">
      <img src="/hero-precocerto-comparacao-hd-2026.webp" alt="Mulher comparando preços pelo celular durante as compras no supermercado" width="2559" height="1440" fetchPriority="high" sizes="100vw" />
    </div>
