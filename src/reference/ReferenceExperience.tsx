...
export function Brand({ inverse = false }: { inverse?: boolean }) {
  return <Link className="ref-brand" to="/" aria-label="PreçoCerto — início">
    {inverse
      ? <img className="ref-brand__inverse" src="/logo-preco-certo-inversa.svg?v=9" alt="PreçoCerto" />
      : <><img className="ref-brand__light" src="/logo-preco-certo.svg?v=9" alt="PreçoCerto" /><img className="ref-brand__dark" src="/logo-preco-certo-inversa.svg?v=9" alt="" aria-hidden="true" /></>}
