...
<Route path="/" element={<HomeProfessional2026/>}/><Route path="/buscar" element={<SearchDiscovery2026/>}/><Route path="/explorar" element={<SectorHub2026/>}/><Route path="/mercados" element={<MarketplaceSectorLanding sector={marketplaceSectors[0]}/>}/><Route path="/farmacias" element={<MarketplaceSectorLanding sector={marketplaceSectors[1]}/>}/><Route path="/padarias" element={<MarketplaceSectorLanding sector={marketplaceSectors[2]}/>}/><Route path="/livros" element={<MarketplaceSectorLanding sector={marketplaceSectors[3]}/>}/><Route path="/servicos" element={<MarketplaceSectorLanding sector={marketplaceSectors[4]}/>}/>
<Route path="/produto/:identifier" element={<ProductDetailProfessional/>}/><Route path="/estabelecimentos" element={<ReferenceStoresPage/>}/><Route path="/kelly-burgueria" element={<KellyBurgueriaPage/>}/><Route path="/estabelecimento/kelly-burgueria-lanchonete" element={<KellyBurgueriaPage/>}/><Route path="/loja/kelly-burgueria-lanchonete" element={<KellyBurgueriaPage/>}/><Route path="/ponto-do-sanduba" element={<PontoDoSandubaPage/>}/><Route path="/estabelecimento/ponto-do-sanduba" element={<PontoDoSandubaPage/>}/><Route path="/loja/ponto-do-sanduba" element={<PontoDoSandubaPage/>}/><Route path="/estabelecimento/:identifier" element={<StoreDetailProfessional/>}/><Route path="/loja/:identifier" element={<StoreDetailProfessional/>}/><Route path="/cesta" element={<ProfessionalBasketPage/>}/><Route path="/cesta-basica" element={<ProfessionalBasketPage/>}/><Route path="/cesta-inteligente" element={<SmartBasketPage/>}/><Route path="/favoritos" element={<ReferenceFavoritesPage/>}/><Route path="/minha-conta" element={<UserAccountPage/>}/>
