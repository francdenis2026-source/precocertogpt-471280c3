...
export default function App(){return <BrowserRouter><FavoritesProvider><a className="pc-skip-link" href="#conteudo-principal">Pular para o conteúdo</a><RouteFocusManager/><ProductCardQuickActions/><FooterDeveloperInfo/><UserAccountHub/><Routes>
